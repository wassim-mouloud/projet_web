  ...
  return (
    <div className='' >
        ...
        <form className='h-[100vh] w-screen flex flex-col justify-center items-center gap-6' >
                ...
                <button type='submit' onClick={loginUser} className='flex justify-center items-center text-white text-[18px] md:text-[20px] rounded-md h-[55px] w-[80vw] md:w-[450px] sm:w-[380px] lg:w-[500px]  p-5 bg-[#0072d2] font-normal' >Login</button>
